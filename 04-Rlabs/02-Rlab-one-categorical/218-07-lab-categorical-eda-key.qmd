...
12. The code above creates the stacked, filled, and dodged barplots. What part of the code changes the way the bars are displayed between the three types of plots?
