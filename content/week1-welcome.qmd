...
![Then print from browser to PDF](img/printing-slides-4.png)
...
1. prepared reading notes or annotations of assigned reading
2. obtained a copy of the slides for taking notes
3. obtained a copy of activity or lab handouts
...
1.  What then do we mean by "cause" when we say that smoking causes cancer?
2.  What do you imagine the evidence might be for this claim?
3.  How would you design a study to test the hypothesis that smoking causes cancer? 
