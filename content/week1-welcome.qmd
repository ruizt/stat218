...
7.  Here purely out of interest?
:::

## Uncertainty {.smaller}

Statistics is largely concerned with uncertainty. Many outcomes in life are uncertain, and this can make a lot of questions hard to answer:
...
-   principles for designing studies in order to understand outcome variability
-   data analytic tools for separating *random* from *systematic* outcome variability
-   heuristics for answering questions while accounting for uncertainty, called *statistical inferences*
...
-   minimal math, theory, and computation
...
| 5 (2/5/24)       | Two-sample inference for numerical data; nonparametric alternatives | HW3         |
...
Your letter grade will be based on the tally of fully met and partly met outcomes. Details are in the syllabus, but:

-   Must at partly or fully meet at least 6 to pass, 8 for B or better, 10 for A or better

```{=html}
<!-- -->
```
-   Beyond that, letter grade is determined by the number of outcomes fully met
...
-   attendance expected; more than two unexcused absences may impact grade
