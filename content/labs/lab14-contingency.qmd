...
- rows should be ordered so that the group of interest appears second
- columns should be ordered so that the outcome of interest appears second
...
hiring <- case1901 |> column_to_rownames('Gender') |> as.matrix() |> as.table() 
hiring
```
