...
oddsratio(greentea.tbl, rev = 'columns')
```
...
3. [L8] The `sulphin` dataset contains observations from an experiment studying the efficacy of Sulphinpyrazone for treating patients who have had a heart attack. 
    ...
    a. [L8] At the 10% significance level, test for an effect of treatment and compute an interval estimate for the relative risk of death in the treatment group compered with the control group at the appropriate confidence level. Be sure to check assumptions for the test.
