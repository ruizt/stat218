...
To access course materials, engage in class, and complete assignments, you'll need an internet-connected laptop or tablet with a keyboard — the keyboard is necessary since we will do some web-hosted computation and you will be expected to type assignments. I'll let you know in advance when you need to bring a laptop/tablet to class. Besides your personal computer, all materials are free.

**Textbook**: Vu and Harrington (2020). [Introdutory Statistics for the Life and Biomedical Sciences](https://www.openintro.org/book/biostat/), First edition. A PDF and tablet-friendly version are available for free online at the link above; we will cover chapters 1 – 2, 4 – 6, and 8.
...
Students wanting more depth of coverage may wish to consult the following resources (available online or through the Kennedy Library):

-   Van Belle, Fisher, Heagerty, and Lumley (2004). [Biostatistics: a methodology for the health sciences](https://csu-calpoly.primo.exlibrisgroup.com/permalink/01CALS_PSU/1qh1nk7/alma991005991838302920). Wiley. This text provides a thorough introduction to biostatistics (statistics for life sciences) and is an excellent reference for more detailed discussion of methods covered in STAT218 and some more advanced methods *not* covered in STAT218. Students may find portions of the text more challenging than the OpenIntro book we are using for the course, but much of the material remains accessible and extensive notes are provided at the end of each chapter to help fill in any conceptual/mathematical gaps in understanding.

-   Douglas *et al.* (2023). [An Introduction to R](https://intro2r.com). This online book covers a variety of introductory topics pertaining to R/RStudio: installation, packages, files and directories, objects, functions, data types, data structures, graphics, basic statistics, markdown, and version control.
