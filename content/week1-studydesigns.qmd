...
![](img/prospective-diagram.png){width="400" height="184"}
:::

::: {.column width="0.5"}
In **retrospective** studies participants are recruited *after* developing a condition

![](img/retrospective-diagram.png){width="400" height="184"}
:::
:::
...
::: {.column width="0.5"}
![Graphical summary of LEAP results.](img/leap-2.png){width="\"300"}
:::
:::
