...
3. Based on the scatterplot above, does it appear that there is a relationship between driving distance and percent accuracy? Explain.
...
4. Set up the null and alternative hypotheses for testing for an association using the slope.


5. Fill in the code below as if you were running a linear regression model.
...
6. Check the assumptions/conditions for using simple linear regression on our data:
...
7. Using the output from the code above, write the equation of the regression line in the context of the problem.
...
9. State your conclusion in context of the research question. Cite evidence to support your conclusion.

\vspace{1.5in}

10. Interpret the 95% confidence interval for the slope.

\vspace{1.5in}

11. Suppose you have a golfer with a driving distance of 280 yards. What would you expect their accuracy to be?

\vspace{0.8in}

12. Assume that same golfer has an actual accuracy of 71%, what is the residual for this golfer?

\vspace{0.8in}

13. Instead, assume that same golfer has an actual accuracy of 55%, what is the residual for this golfer?
