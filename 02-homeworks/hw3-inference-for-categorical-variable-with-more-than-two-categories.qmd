...
5.  The value in the first row and second column is 23.46 (i.e. Observed count for the Brown Swiss breed). Explain where this number came from. What does this value represent?

\vspace{0.8in}

6.  Complete the empty cells in the second row to contain the expected outcome for each of the breeds.
...
14. Select the correct code/output below to test the hypotheses.
