...
nyc_trees <- read_csv("data/new_york_tree_census_2015.csv") |> 
  ...
  select(tree_id, tree_dbh, status, spc_common, sidewalk) |> 
  filter(tree_dbh < 100) |> 
  sample(672)
```
...
14.	Construct a 95% confidence interval for the true difference in mean diameter between Honeylocust and Norway Maple trees.
