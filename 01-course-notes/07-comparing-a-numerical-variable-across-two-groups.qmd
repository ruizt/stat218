...
2.	standard deviation of the sampling distribution (i.e., standard error) = $$\sqrt{\frac{s_1}{n_1^2} + \frac{s_2}{n_2^2}}$$
...
$$T= \frac{\text{observed value}-\text{null value}}{\text{standard error}}= \frac{(\bar x_1 - \bar x_2)-(\mu_1 - \mu_2)}{\sqrt{\frac{s_1}{n_1^2} + \frac{s_2}{n_2^2}}}$$
...
$$(\bar x_1 - \bar x_2) \pm \text{t-quantile}$$
